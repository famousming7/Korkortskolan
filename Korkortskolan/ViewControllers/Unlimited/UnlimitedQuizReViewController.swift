...
class UnlimitedQuizReViewController: UIViewController ,UITableViewDelegate,UITableViewDataSource {
    ...
    func getQuizList(){
        if let data = UserDefaults.standard.object(forKey: "unlimited_quiz_res_" + unlimited_id) as? NSData {
